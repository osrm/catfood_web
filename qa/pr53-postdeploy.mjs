...
await verifyViewport(390, 844, 62, 'mobile390', 'pages-home-390x844.png')
await verifyViewport(1440, 900, 68, 'desktop1440', 'pages-home-1440x900.png')

assert.equal(report.blockedAttempts.length, 0, 'live Pages attempted no write/analytics requests')
...
console.log('CATFOOD_PR53_POSTDEPLOY=' + JSON.stringify(report))
console.log(short)
